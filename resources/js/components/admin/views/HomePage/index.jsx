...
const HomePage = () => {
    ...
    const onSubmitForm = async (data) => {
        if (updateIndex === null) {
            ...
            const componentTerm = listSelectedComponent.find(
                (component) =>
                    component.componentParams.title.toLowerCase() ===
                    data.formData.title.toLowerCase(),
            );
                                ...
                                <GridItem xs={12} sm={12} md={12}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {Object.keys(systemComponent).map(
                                                (item) => (
                                                    <MenuItem
                                                        key={item}
                                                        value={item}
            ...
            <GridContainer>
                <GridItem xs={12} sm={12} md={12}>
                    <Card>
                        ...
                        <CardFooter>
                            <Button color="primary" onClick={onSaveLandingPage}>
                                Save
                            </Button>
                        </CardFooter>
                    </Card>
