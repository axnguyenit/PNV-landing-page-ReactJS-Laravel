...
const VideoSection = (props) => {
    return (
      <section className="video p-100px-tb overlay overlay-6 parallax" style={{backgroundImage: `url(${props.file})`}} data-aos={props.aos}>
        <div className="container">
          <div className="row">
            <div className="col-sm-8 offset-sm-2 text-center promo-video">
              <h1 className="m-0px-b">{props.title}</h1>
              <h4 className="m-30px-b sm-m-25px-b" dangerouslySetInnerHTML={{ __html: props.slogan }}></h4>
