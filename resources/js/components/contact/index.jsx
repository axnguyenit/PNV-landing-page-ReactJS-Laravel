              ...
              <div className="contact-form-box bg-light">
                <form id="contact-form" onSubmit={onSubmit}>
                  <div className="message col">
                    {stt === "Sending..." ? <p className="email-loading alert alert-warning"><img src="./assets/images/loading.gif" alt="" />&nbsp;&nbsp;&nbsp;{stt}</p> : null}
                    {stt === "Your info has successfully been sent." ? <p className="email-success alert alert-success"><i className="icon icon-icon-check-alt2" />{stt}</p> : null}
                    {errTxt ? <p className="email-failed alert alert-danger"><i className="icon icon-icon-close-alt2" />{errTxt}</p> : null}
                  </div>
                  <div className="mb13">
                    <input name="name" className="contact-name" id="contact-name" type="text" onChange={onChange} placeholder="Your Name" required />
                  </div>
                  <div className="mb13">
                    <input name="email" className="contact-email" id="contact-email" type="email" onChange={onChange} placeholder="Your Email" required />
                  </div>
                  <div className="mb13">
                    <input name="subject" className="contact-subject" id="contact-subject" type="text" onChange={onChange} placeholder="Subject" required />
                  </div>
                  <div className="mb30">
                    <textarea name="message" className="contact-message" id="contact-message" onChange={onChange} placeholder="Your Message" required defaultValue={""} />
                  </div>
